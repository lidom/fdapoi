...
#setwd("/home/dom/ownCloud/PoIGLMShared/R_Codes_and_Data/Simulation")
#plot_path <- "/home/dom/ownCloud/PoIGLMShared/Figures"

setwd("D:/DropBox/Dropbox/DoktorArbeit/Paper3/Logistic Regression With Points Of Impact/GLM with Points of Impact/PoIGLMShared/R_Codes_and_Data/Simulation/Sim_Results")
plot_path <- "D:/DropBox/DropBox/DoktorArbeit/Paper3/Logistic Regression With Points Of Impact/GLM with Points of Impact/PoIGLMShared/Figures"
setwd("C:/Users/hakir/sciebo/DoktorArbeit//Paper3/Logistic Regression With Points Of Impact/GLM with Points of Impact/PoIGLMShared/R_Codes_and_Data/Simulation/Sim_Results")
plot_path <- "C:/Users/hakir/sciebo/DoktorArbeit/Paper3/Logistic Regression With Points Of Impact/GLM with Points of Impact/PoIGLMShared/Figures"
...
load(paste0("Sim_Results_DGP=", DGP, "_N=", N, "_p=", p, ".RData"))
...
#################
#library(grid)
#Plot_DGP1<-grid.arrange(arrangeGrob(Plot_DGP1_3, Plot_DGP1_1, Plot_DGP1_2, nrow=1,
# top = "Estimation errors for different sample sizes n"),mylegend, nrow=2,heights=c(6,0.5))
